...
@pytest.mark.parametrize(
    "query,expect",
    [(i, i) for i in usfm_references.BOOKS]
    + [(i.lower(), i) for i in usfm_references.BOOKS]
    + [("ZZZ", None), ("zzz", None)],
)
...
def test_book_lookup_by_abbr():
    ...
    assert usfm_references.book_lookup("Jdgs") == "JDG"
    ...
    assert usfm_references.book_lookup("Ezk") == "EZK"
